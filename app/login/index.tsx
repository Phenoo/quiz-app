...
const Pageindex = () => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.small} >Enter details to log in</Text>
      ...
      <View style={{ width: "100%", marginTop:10}}>
        <View style={{ gap: 16 }}>
          ...
          <Text style={{color: "#ff5b5e", textAlign: 'right', fontSize: 16}}>
            Forgot password?
          </Text>
        </View>
        ...
        <View style={{alignItems: "center", flexDirection: "row", justifyContent: "center", marginTop: 10, gap: 4}}>
            <Text style={{opacity: 0.7}}>Don't have Acount?</Text>
            <Pressable onPress={() => router.push("/register")}><Text>Sign Up</Text></Pressable>
        </View>

      </View>

      <View style={{alignItems: "center", gap: 20, position: "absolute", bottom: 50, width: "100%"}}>
